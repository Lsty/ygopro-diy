--义妹·奎兹马菲
function c74700150.initial_effect(c)
	--pendulum summon
	...
	e1:SetCountLimit(1,74700150+EFFECT_COUNT_CODE_OATH)
	e1:SetTarget(c74700150.target)
	e1:SetOperation(c74700150.activate)
	c:RegisterEffect(e1)
	--splimit
	...
	e2:SetTarget(c74700150.splimit)
	c:RegisterEffect(e2)
end
function c74700150.splimit(e,c,tp,sumtp,sumpos)
	return not c:IsType(TYPE_NORMAL) and not c:IsSetCard(0x747) and c:IsLocation(LOCATION_HAND+LOCATION_DECK)
end
function c74700150.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c74700150.activate(e,tp,eg,ep,ev,re,r,rp)
