--轨迹-亚里欧斯
function c20110956.initial_effect(c)
	--act limit
	...
	e7:SetCondition(c20110956.accon)
	e1:SetValue(c20110956.aclimit)
	c:RegisterEffect(e1)
