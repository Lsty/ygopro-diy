...
function c114000400.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return (d~=nil and a:GetControler()==tp and ( a:IsSetCard(0x221) or a:IsSetCard(0x225) ) and a:IsRelateToBattle())
		or (d~=nil and d:GetControler()==tp and d:IsFaceup() and ( d:IsSetCard(0x221) or d:IsSetCard(0x225) ) and d:IsRelateToBattle())
end
